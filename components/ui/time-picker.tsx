      ...
      <PopoverTrigger asChild>
        <div className="relative w-full">
          <Input
            ...
            className={cn(
              "w-full h-12 px-4 rounded-md border border-gray-300 focus:border-gray-400 focus:ring-0 cursor-pointer text-base",
              className,
            )}
            readOnly
      ...
      <PopoverContent className="w-72 p-4 border-gray-200" align="start">
        <div className="flex flex-col space-y-4">
          <div className="flex justify-between items-center">
            <div className="text-base font-medium">Hours</div>
            <div className="flex items-center space-x-2">
              ...
              <span className="w-8 text-center text-base">{hours}</span>
              <Button
                variant="outline"
                size="sm"
                className="h-9 w-9 p-0 text-base"
          ...
          <div className="flex justify-between items-center">
            <div className="text-base font-medium">Minutes</div>
            <div className="flex items-center space-x-2">
              <Button
                variant="outline"
                size="sm"
              ...
              <span className="w-8 text-center text-base">{minutes.toString().padStart(2, "0")}</span>
              <Button
                variant="outline"
                size="sm"
                className="h-9 w-9 p-0 text-base"
          ...
          <div className="flex justify-between items-center">
            <div className="text-base font-medium">AM/PM</div>
            <div className="flex items-center space-x-2">
              <Button
                ...
                className={cn(
                  "px-3 text-base",
                  period === "AM" && "bg-[#b5d333] text-black hover:bg-[#a2c129] hover:text-black",
                )}
              ...
              <Button
                ...
                className={cn(
                  "px-3 text-base",
                  period === "PM" && "bg-[#b5d333] text-black hover:bg-[#a2c129] hover:text-black",
                )}
        ...
        <div className="flex justify-between items-center mt-4 pt-3 border-t border-gray-100">
          <Button
            variant="ghost"
            className="text-[#b5d333] hover:text-[#a2c129] hover:bg-transparent font-medium text-base"
